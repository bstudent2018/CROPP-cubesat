...
class CameraApp:
	def __init__(self, outputPath,root,multiAdapter):
		...
		#self.root.parent().wm_title("PyImageSearch PhotoBooth")
		#self.root.parent().wm_protocol("WM_DELETE_WINDOW", self.onClose)
...
>>>>>>> c02842c4ae4a0d998f1a162582ff31d3906df700
