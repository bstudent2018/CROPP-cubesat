...
def toggleSteppers():
    writeToArduino(b'toggleSteppers')

def toggleStepper1():
    writeToArduino(b'toggle1')

def toggleStepper2():
    writeToArduino(b'toggle2')
...
def makeStepperButtons():
    ...
    toggleBoth = Button(stepperFrame,text="Toggle Both Steppers",command=toggleSteppers,width=10,height=5,bg='blue')
    toggleBoth.grid(row=2,column=0,columnspan=2)
    toggle1 = Button(stepperFrame,text="Toggle Stepper 1",command=toggleStepper1,width=10,height=5)
    toggle1.grid(row=1,column=0)
    toggle2 = Button(stepperFrame,text="Toggle Stepper2", command=toggleStepper2,width=10,height=5)
    toggle2.grid(row=1,column=1)
...
class Autonomouos:
    def __init__(self):
        self.lightHoursOn = 5
        self.lightHoursOff= 24-self.lightHoursOn
