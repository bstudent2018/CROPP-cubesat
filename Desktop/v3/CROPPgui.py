...
def makePumpButtons():
    ...
    pumps.append(Checkbutton(pumpFrame,text="Pump 1",command = lambda: togglePump(0),width = 10,variable=pumpValues[0]))
    pumps.append(Checkbutton(pumpFrame,text="Pump 2",command = lambda: togglePump(1),width = 10,variable=pumpValues[1]))
    pumps.append(Checkbutton(pumpFrame,text="Pump 3",command = lambda: togglePump(2),width = 10,variable=pumpValues[2]))
    pumps.append(Checkbutton(pumpFrame,text="Pump 4",command = lambda: togglePump(3),width = 10,variable=pumpValues[3]))
    pumps.append(Checkbutton(pumpFrame,text="Pump 5",command = lambda: togglePump(4),width = 10,variable=pumpValues[4]))
    pumps.append(Checkbutton(pumpFrame,text="Pump 6",command = lambda: togglePump(5),width = 10,variable=pumpValues[5]))
    pumps.append(Checkbutton(pumpFrame,text="Pump 7",command = lambda: togglePump(6),width = 10,variable=pumpValues[6]))
    pumps.append(Checkbutton(pumpFrame,text="Pump 8",command = lambda: togglePump(7),width = 10,variable=pumpValues[7]))
    pumps.append(Checkbutton(pumpFrame,text="Pump 9",command = lambda: togglePump(8),width = 10,variable=pumpValues[8]))
    pumps.append(Checkbutton(pumpFrame,text="Pump 10",command = lambda: togglePump(9),width = 10,variable=pumpValues[9]))
    pumps.append(Checkbutton(pumpFrame,text="Pump 11",command = lambda: togglePump(10),width = 10,variable=pumpValues[10]))
    pumps.append(Checkbutton(pumpFrame,text="Pump 12",command = lambda: togglePump(11),width = 10,variable=pumpValues[11]))
...
class tempHumid:
    ...
    def refreshValues(self):
        ...
        try:
            ...
            print("Invalid temperature values recieved")
