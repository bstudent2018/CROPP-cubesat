//Reference: https://www.electroniclinic.com/water-flow-sensor-arduino-water-flow-rate-volume-measurement/
...
/*The hall-effect flow sensor outputs pulses per second per litre/minute of flow. Added a zero here*/
float calibrationFactor = 900; //You can change according to your datasheet
